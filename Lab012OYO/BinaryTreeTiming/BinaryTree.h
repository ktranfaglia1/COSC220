...
//****************************************************************
// This function calls the recursive load in order function with
// the root of the tree to load all the elements of the tree into
// an array using an in order traversal
//****************************************************************

template<class T>
void BinaryTree<T>::loadInOrder(T A[]) {
	int position = 0;
	loadInOrderRec(root, A, position);
}

//****************************************************************
// This function is a recursive load in order function that takes
// the root node, an array, and a position variable and does
// a recursive in order traversal and loads the elements of the 
// tree into the array in order
//****************************************************************
